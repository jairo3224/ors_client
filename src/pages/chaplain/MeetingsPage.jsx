...
const MOCK_MEETINGS = [
  { id: 1, title: 'Pastoral Care Review - Carlo Mendoza', date: '2026-06-02', time: '10:00', type: 'Pastoral Review', status: 'Scheduled', participants: 'Chaplain, Guidance, Student', notes: 'Review progress of pastoral counseling.', outcome: '' },
  { id: 2, title: 'Crisis Support Planning - Dante Villanueva', date: '2026-06-01', time: '14:00', type: 'Crisis Planning', status: 'Scheduled', participants: 'Chaplain, OSAS, Parent', notes: 'Develop support plan for student in crisis.', outcome: '' },
  { id: 3, title: 'Spiritual Formation Planning', date: '2026-05-25', time: '09:00', type: 'Planning Session', status: 'Completed', participants: 'Chaplain, Campus Ministry', notes: 'Planned upcoming spiritual formation activities.', outcome: 'Calendar of events finalized for the semester.' },
];

const BLANK_FORM = { title: '', date: '', time: '', type: 'Pastoral Review', status: 'Scheduled', participants: '', notes: '', outcome: '' };
const TYPE_OPTIONS = ['Pastoral Review', 'Crisis Planning', 'Spiritual Direction', 'Planning Session', 'Referral Conference'];
...
export default function ChaplainMeetingsPage() {
  ...
  return (
    <div className="space-y-4">
      <div className="page-header">
        ...
        <p className="page-subtitle">Schedule and document pastoral case meetings and reviews</p>
      </div>
          ...
          <div key={meeting.id} className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-sm transition-shadow">
            <div className="flex items-start justify-between mb-2">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center text-white text-sm font-bold bg-amber-600">
                  <Users size={18} />
                </div>
                <div>
      ...
      <div className="space-y-3 text-sm">
        <div>
          ...
          <input value={form.title} onChange={e => set('title', e.target.value)}
            className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200" placeholder="e.g., Pastoral Review - Student Name" />
        </div>
        ...
        <div>
          ...
          <input value={form.participants} onChange={e => set('participants', e.target.value)}
            className="w-full border border-gray-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-200"
            placeholder="e.g., Chaplain, Guidance, Student, Parent" />
        </div>
        <div>
