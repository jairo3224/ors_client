...
import { getStats, getReferrals } from './api';
import { FileText, Clock, Activity, CheckCircle, AlertCircle } from 'lucide-react';
...
const STAT_CONFIG = [
  ...
  { key: 'active',   label: 'Active Cases',    icon: Activity,     bg: '#a8d4f0', border: '#5898c8', numColor: '#0c447c', labelColor: '#185fa5' },
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {!loading && referrals.length === 0 && (
                <tr><td colSpan={5} className="text-center py-10 text-gray-400 text-sm">No recent referrals.</td></tr>
              )}
              {referrals.map((r, i) => (
