...
import { Plus, Search, X, Upload, Eye, Pencil, Trash2, AlertCircle, FileText } from 'lucide-react';
    ...
    <Modal title="Referral Details" onClose={onClose}>
      <dl className="space-y-3 text-sm">
        ...
        <div className="flex gap-2">
          ...
          <dd className={`font-medium ${referral.description ? 'text-gray-800' : 'text-gray-300'}`}>{referral.description || '—'}</dd>
        </div>
        <div className="flex gap-2 items-center">
